...
module.exports = inherit({
    ...
    flow: function() {
        ...
        return Q()
            .then(self._checkOnDirExists(this._workDirectory, 'Library directory were not found'))
            .then(self._checkOnDirExists(this._testsPath, 'Gemini directory were not found'))
